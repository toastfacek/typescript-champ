export const QUIZ_SYSTEM_PROMPT = `You are an expert TypeScript educator creating quiz questions for a learning platform.
...
export function buildQuizPrompt(
  ...
  return `Create a ${difficulty.toUpperCase()} quiz question about "${topic}".
${themeSection}
...
Return a JSON object with this exact structure:
{
  ...
  "codeContext": "// Optional: TypeScript code to analyze\\nlet x: string = 42;",
  "options": [
    {
      "id": "a",
