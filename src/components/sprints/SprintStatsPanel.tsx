...
export function SprintStatsPanel({
  ...
  return (
    <Card className="sticky top-4" padding="lg">
      {/* Header */}
      <div className="mb-6">
        <h3 className="text-sm font-heading font-bold text-surface-400 uppercase tracking-wide mb-1">
          Sprints Progress
        </h3>
        <div className="text-xs text-surface-500 capitalize">{language}</div>
      </div>
      ...
      <div className="mb-6 p-4 bg-gradient-to-br from-accent-500/10 to-accent-600/5 rounded-lg border border-accent-500/20">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-surface-400">Total Sprint XP</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-surface-400">Modules Completed</span>
      ...
      {/* Current Module */}
      {currentModule && (
        <div className="mb-6 p-3 bg-surface-800/50 rounded-lg border border-surface-700">
          <div className="text-xs text-surface-500 mb-1">Current Sprint</div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 bg-surface-800/30 rounded-lg">
          <div className="text-xs text-surface-500 mb-1">Unlocked</div>
          <div className="text-xl font-heading font-bold text-surface-200">
      ...
      <div className="mt-6 pt-6 border-t border-surface-700">
        <div className="text-sm text-surface-400 italic text-center">
